    ...
    <div className="room-container">
       ...
       {customQuestion && (
         <div style={{background: '#ffebee', padding: '15px', borderRadius: '8px', marginBottom: '20px', border: '1px solid #ffcdd2', textAlign: 'left'}}>
           <strong style={{color: '#d32f2f'}}>🔔 Câu hỏi phụ:</strong> 
       ...
       <div className="button-group">
         {!isRecording && !isUploading && (
           <button onClick={handleStartRecording} className="btn btn-success">🎥 Bắt đầu trả lời</button>
         )}
         {isRecording && (
           <button onClick={handleNextQuestion} disabled={isUploading} className="btn btn-primary">
             {isUploading ? "⏳ Đang gửi..." : "Tiếp theo ➡"}
           </button>
         )}
       </div>
    </div>
